...
drop materialized view if exists pneumonia.vitalsfirstday cascade; 

create materialized view pneumonia.vitalsfirstday as
		...
		, case
			...
			from pneumonia.allevents order by time
